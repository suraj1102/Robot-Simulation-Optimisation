...
% This script (main.m) calls 2 external functions
%     ODEEuler  (general purpose ODE solver)
%     myRHS     (The right hand side of the ODEs)
...
RHS = @(t,z)  myRHS(t,z,p);  % define RHS(t,z) from myRHS(t,z,p)

% Here is where we call the ODE solver, in this case ODEEuler.
% It is below.  Later we will call professional solvers.
% The solver needs the name of the RHS file, the time interval and the ICs
...
% The stuff below helps keep track of things in the command window.
